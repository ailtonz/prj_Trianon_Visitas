...
my $Cliente = 'cliente_nome';
my $smtp	= 'smtp.sao.terra.com.br:587';
my $to		= 'usuario_nome@terra.com.br';
my $senha	= 'usuario_senha';
my $cc		= 'empresa_nome@terra.com.br,empresa_nome@gmail.com';
